...
> **453** servers catalogued | **10** categories | Last scan: **2026-07-31 09:55 UTC**
...
**Transports:** `stdio`: 240 · `sse`: 349 · `streamable-http`: 118 · `unknown`: 66
...
| 5 | [mcporter](https://github.com/openclaw/mcporter) | █████████░ **90** | 4.9k | Call MCPs via TypeScript, masquerading as simple TypeScript API. Or pa | `other` | `stdio` `SSE` `HTTP` |
...
| 8 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **89** | 2.8k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
...
| 12 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 27.0k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 13 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **89** | 11.0k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
| 14 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **89** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `HTTP` |
...
| 17 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **88** | 28.8k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
...
| 20 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **88** | 4.4k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
| 21 | [CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext) | █████████░ **88** | 4.0k | An MCP server plus a CLI tool that indexes local code into a graph dat | `data` | `SSE` |
...
| 25 | [critical](https://github.com/addyosmani/critical) | █████████░ **87** | 10.3k | Extract & Inline Critical-path CSS in HTML pages | `other` | `stdio` `SSE` |
| 26 | [optillm](https://github.com/algorithmicsuperintelligence/optillm) | █████████░ **87** | 4.2k | Optimizing inference proxy for LLMs | `ai-ml` | `stdio` `SSE` |
| 27 | [tabularis](https://github.com/TabularisDB/tabularis) | █████████░ **87** | 4.0k | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLit | `data` | `stdio` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 63.5k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [fastmcp](https://github.com/PrefectHQ/fastmcp) | ⭐ 27.0k | 89 | 🚀 The fast, Pythonic way to build MCP servers and clients. |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 835 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [TrendRadar](https://github.com/sansan0/TrendRadar) | ⭐ 61.0k | 63 | ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS,  |
...
| [mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) | ⭐ 671 | 0 | Go server implementing Model Context Protocol (MCP) for filesystem operations. |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 91.6k | 65 | A collection of MCP servers. |
...
| [aisuite](https://github.com/andrewyng/aisuite) | ⭐ 15.8k | 82 | Simple, unified interface to multiple Generative AI providers  |
...
| [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | ⭐ 11.0k | 89 | AI-powered reverse engineering assistant that bridges IDA Pro with language mode |
| [inspector](https://github.com/modelcontextprotocol/inspector) | ⭐ 10.5k | 68 | Visual testing tool for MCP servers |
...
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 767 | 0 | An MCP server for interacting with Google Colab |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 406 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
...
| [Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server) | ⭐ 384 | 0 | A MCP Server for Google Scholar: 🔍 Enable AI assistants to search and access Goo |
| [mcp-email-server](https://github.com/Wh1isper/mcp-email-server) | ⭐ 297 | 0 | IMAP and SMTP via MCP Server |
...
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.2k | today | 642/650 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | yesterday | 461/461 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.7k | 2d ago | 137/138 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.9k | 3d ago | 106/108 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/253 | **89** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.7k | 6d ago | 874/882 | **89** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.8k | 2d ago | 60/63 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.5k | today | 120/131 | **89** |
...
- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 91.6k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-07-31 09:55 UTC*
