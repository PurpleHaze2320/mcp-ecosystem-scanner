...
> **452** servers catalogued | **10** categories | Last scan: **2026-08-07 08:26 UTC**
...
| 3 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **90** | 35.9k | Playwright MCP server | `web` | `stdio` `SSE` |
...
| 13 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **89** | 11.2k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
| 14 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **88** | 19.7k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 19 | [python-sdk](https://github.com/modelcontextprotocol/python-sdk) | █████████░ **88** | 23.9k | The official Python SDK for Model Context Protocol servers and clients | `dev-tools` | `stdio` `SSE` `HTTP` |
...
| 21 | [apify-mcp-server](https://github.com/apify/apify-mcp-server) | █████████░ **88** | 2.8k | The Apify MCP server enables your AI agents to extract data from socia | `web` | `stdio` `SSE` `HTTP` |
...
| 23 | [linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | █████████░ **88** | 3.0k | Open-source MCP server for LinkedIn. Give Claude and any MCP-compatibl | `ai-ml` | `stdio` `SSE` `HTTP` |
...
| 25 | [tabularis](https://github.com/TabularisDB/tabularis) | █████████░ **88** | 4.0k | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLit | `data` | `stdio` |
| 26 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **87** | 28.9k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
...
| 28 | [mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | █████████░ **87** | 5.7k | MCP server for Atlassian tools (Confluence, Jira) | `productivity` | `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 65.3k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [tabularis](https://github.com/TabularisDB/tabularis) | ⭐ 4.0k | 88 | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLite and 15+  |
...
| [unifi-mcp](https://github.com/sirkirby/unifi-mcp) | ⭐ 651 | 0 | MCP servers for the UniFi suite of applications, Network, Protect, Access, and D |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 91.9k | 64 | A collection of MCP servers. |
...
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 800 | 0 | An MCP server for interacting with Google Colab |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 418 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
...
| [mcp-email-server](https://github.com/Wh1isper/mcp-email-server) | ⭐ 301 | 0 | Full-featured, multi-account MCP email server for Windows, macOS, and Linux—read |
...
| [anything-analyzer](https://github.com/Mouseww/anything-analyzer) | ⭐ 3.4k | 80 | 全能协议分析工具：浏览器抓包 + MITM 代理 + 指纹伪装 + AI 分析 + MCP Server 无缝对接 AI Agent/IDE   |  All- |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 2.8k | 88 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.9k | yesterday | 880/881 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.8k | today | 138/140 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.3k | today | 663/668 | **90** |
| **Figma-Context-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 15.6k | today | 170/177 | **90** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.7k | yesterday | 126/132 | **89** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.9k | today | 60/64 | **89** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/255 | **89** |
| **ghidra-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.2k | today | 95/105 | **89** |

---

## 💡 Key Insights

- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 91.9k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-08-07 08:26 UTC*
