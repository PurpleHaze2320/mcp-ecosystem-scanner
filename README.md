...
> **456** servers catalogued | **10** categories | Last scan: **2026-07-23 09:39 UTC**
...
**Languages:** **TypeScript**: 209 · **Python**: 203 · **Go**: 13 · **JavaScript**: 11 · **Unknown**: 8 · **C#**: 3

**Transports:** `stdio`: 239 · `sse`: 349 · `streamable-http`: 115 · `unknown`: 69
...
|--------|-------|----------|----------|---------|
| [darknet-mcp-server](https://github.com/badchars/darknet-mcp-server) | ⭐ 264 | TypeScript | `web` | ░░░░░░░░░░ 0 |
...
| 3 | [notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli) | █████████░ **90** | 5.6k | Programmatic access to Google NotebookLM — via command-line interface  | `productivity` | `SSE` |
...
| 8 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **89** | 35.4k | Playwright MCP server | `web` | `stdio` `SSE` |
| 9 | [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | █████████░ **89** | 6.5k | MCP Server for Computer Use in Windows | `other` | `stdio` `SSE` `HTTP` |
| 10 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **89** | 28.6k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
| 11 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **89** | 19.2k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
| 12 | [ghidra-mcp](https://github.com/bethington/ghidra-mcp) | █████████░ **89** | 2.9k | Ghidra MCP Server — 200+ MCP tools for AI-powered reverse engineering. | `dev-tools` | `stdio` `SSE` `HTTP` |
| 13 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **89** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `SSE` `HTTP` |
| 14 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 26.8k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
...
| 16 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 10.7k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
| 17 | [core](https://github.com/opensumi/core) | █████████░ **88** | 3.6k | A framework helps you quickly build AI Native IDE products. MCP Client | `other` | — |
...
| 19 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **88** | 4.3k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
| 20 | [critical](https://github.com/addyosmani/critical) | █████████░ **88** | 10.2k | Extract & Inline Critical-path CSS in HTML pages | `other` | `stdio` `SSE` |
| 21 | [optillm](https://github.com/algorithmicsuperintelligence/optillm) | █████████░ **88** | 4.2k | Optimizing inference proxy for LLMs | `ai-ml` | `stdio` `SSE` |
| 22 | [python-sdk](https://github.com/modelcontextprotocol/python-sdk) | █████████░ **88** | 23.7k | The official Python SDK for Model Context Protocol servers and clients | `dev-tools` | `stdio` `SSE` `HTTP` |
| 23 | [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | █████████░ **88** | 15.5k | MCP server to provide Figma layout information to AI coding agents lik | `other` | `stdio` |
| 24 | [google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) | █████████░ **88** | 2.9k | Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tas | `productivity` | `stdio` `SSE` `HTTP` |
| 25 | [linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | █████████░ **88** | 2.9k | Open-source MCP server for LinkedIn. Give Claude and any MCP-compatibl | `ai-ml` | `stdio` `SSE` `HTTP` |
| 26 | [mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | █████████░ **87** | 5.6k | MCP server for Atlassian tools (Confluence, Jira) | `productivity` | `SSE` |
| 27 | [5ire](https://github.com/nanbingxyz/5ire) | █████████░ **87** | 5.3k | 5ire is a cross-platform desktop AI assistant, MCP client. It compatib | `ai-ml` | `SSE` |
| 28 | [tabularis](https://github.com/TabularisDB/tabularis) | █████████░ **87** | 3.8k | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLit | `data` | `stdio` |
| 29 | [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | █████████░ **87** | 12.9k | The official TypeScript SDK for Model Context Protocol servers and cli | `dev-tools` | `stdio` `HTTP` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 61.3k | 87 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | ⭐ 28.6k | 89 | An autonomous agent that conducts deep research on any data using any LLM provid |
| [fastmcp](https://github.com/PrefectHQ/fastmcp) | ⭐ 26.8k | 89 | 🚀 The fast, Pythonic way to build MCP servers and clients. |
...
| [DeepCode](https://github.com/HKUDS/DeepCode) | ⭐ 16.1k | 85 | "DeepCode: Open Agentic Coding (Paper2Code & Text2Web & Text2Backend)" |
...
| [mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops) | ⭐ 380 | 0 | An MCP server for Azure DevOps |
| [run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda) | ⭐ 376 | 0 | Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda func |
...
| [tabularis](https://github.com/TabularisDB/tabularis) | ⭐ 3.8k | 87 | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLite and 15+  |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 824 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 747 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [TrendRadar](https://github.com/sansan0/TrendRadar) | ⭐ 60.8k | 64 | ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS,  |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 19.2k | 89 | Context window optimization for AI coding agents. Sandboxes tool output (98% red |
...
| [sandbox](https://github.com/agent-infra/sandbox) | ⭐ 5.5k | 68 | All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSC |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 91.2k | 65 | A collection of MCP servers. |
| [servers](https://github.com/modelcontextprotocol/servers) | ⭐ 88.8k | 70 | Model Context Protocol Servers |
...
| [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | ⭐ 10.7k | 88 | AI-powered reverse engineering assistant that bridges IDA Pro with language mode |
...
| [stitch-skills](https://github.com/google-labs-code/stitch-skills) | ⭐ 7.8k | 72 | A library of Agent Skills designed to work with the Stitch MCP server. Each skil |
...
### Productivity (19 servers)

| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [SurfSense](https://github.com/MODSetter/SurfSense) | ⭐ 15.3k | 73 | Open-source NotebookLM alternative. Research the open web with live data(Reddit, |
| [mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | ⭐ 5.6k | 87 | MCP server for Atlassian tools (Confluence, Jira) |
| [notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli) | ⭐ 5.6k | 90 | Programmatic access to Google NotebookLM — via command-line interface (CLI), Mod |
| [NotFair](https://github.com/nowork-studio/NotFair) | ⭐ 3.2k | 78 | Goal-driven, loop-powered marketing agents that crush your business goals 24/7 |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 956 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 736 | 0 | An MCP server for interacting with Google Colab |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 400 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
| [nanobanana-mcp-server](https://github.com/zhongweili/nanobanana-mcp-server) | ⭐ 381 | 0 | AI image generation MCP server powered by Google Gemini, with smart model select |
| [Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server) | ⭐ 380 | 0 | A MCP Server for Google Scholar: 🔍 Enable AI assistants to search and access Goo |
| [mcp-email-server](https://github.com/Wh1isper/mcp-email-server) | ⭐ 288 | 0 | IMAP and SMTP via MCP Server |
| *...and 4 more* | | | |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | ⭐ 35.4k | 89 | Playwright MCP server |
...
| [DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) | ⭐ 8.8k | 84 | This is MCP server for Claude that gives it terminal control, file system search |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 2.2k | 0 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **private-gpt** | ✅ | ✅ | ✅ | ✅ | ✅ | 57.4k | today | 1239/1242 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | today | 461/461 | **90** |
| **notebooklm-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.6k | today | 132/134 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.1k | today | 614/628 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.8k | 2d ago | 104/105 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.8k | yesterday | 60/62 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 236/252 | **89** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.4k | 8d ago | 872/873 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.5k | 2d ago | 120/128 | **89** |
| **gpt-researcher** | ✅ | ✅ | ✅ | ✅ | ✅ | 28.6k | 5d ago | 679/717 | **89** |

---

## 💡 Key Insights

- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 91.2k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-07-23 09:39 UTC*
