...
> **453** servers catalogued | **10** categories | Last scan: **2026-07-28 09:50 UTC**
...
**Transports:** `stdio`: 239 · `sse`: 349 · `streamable-http`: 117 · `unknown`: 67
...
| 3 | [ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | █████████░ **90** | 4.1k | The Unofficial and Awesome Home Assistant MCP Server | `dev-tools` | `stdio` `SSE` `HTTP` |
...
| 12 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 26.9k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 13 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **89** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `HTTP` |
...
| 15 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **88** | 28.7k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
| 16 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 10.8k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 18 | [python-sdk](https://github.com/modelcontextprotocol/python-sdk) | █████████░ **88** | 23.7k | The official Python SDK for Model Context Protocol servers and clients | `dev-tools` | `stdio` `SSE` `HTTP` |
...
| 22 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **88** | 4.4k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
...
| 24 | [critical](https://github.com/addyosmani/critical) | █████████░ **87** | 10.3k | Extract & Inline Critical-path CSS in HTML pages | `other` | `stdio` `SSE` |
| 25 | [optillm](https://github.com/algorithmicsuperintelligence/optillm) | █████████░ **87** | 4.2k | Optimizing inference proxy for LLMs | `ai-ml` | `stdio` `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 62.9k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [aisuite](https://github.com/andrewyng/aisuite) | ⭐ 15.6k | 83 | Simple, unified interface to multiple Generative AI providers  |
...
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 757 | 0 | An MCP server for interacting with Google Colab |
...
| [mcp-email-server](https://github.com/Wh1isper/mcp-email-server) | ⭐ 294 | 0 | IMAP and SMTP via MCP Server |
| [mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc) | ⭐ 252 | 0 | A Model Context Protocol (MCP) server providing access to Google Search Console |
| *...and 3 more* | | | |
...
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.1k | today | 632/637 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.8k | today | 105/107 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.7k | 2d ago | 136/138 | **90** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.6k | 3d ago | 874/880 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/253 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.5k | 3d ago | 120/129 | **89** |
| **ghidra-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.0k | 2d ago | 95/104 | **89** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.8k | 6d ago | 60/63 | **89** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-07-28 09:50 UTC*
