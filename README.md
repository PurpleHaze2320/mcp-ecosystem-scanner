...
> **453** servers catalogued | **10** categories | Last scan: **2026-08-01 09:20 UTC**
...
**Transports:** `stdio`: 241 · `sse`: 348 · `streamable-http`: 119 · `unknown`: 66
...
| 5 | [fast-agent](https://github.com/evalstate/fast-agent) | █████████░ **89** | 3.9k | Code, Build and Evaluate agents - excellent Model and Skills/MCP/ACP/A | `other` | `stdio` `SSE` `HTTP` |
| 6 | [mcporter](https://github.com/openclaw/mcporter) | █████████░ **89** | 4.9k | Call MCPs via TypeScript, masquerading as simple TypeScript API. Or pa | `other` | `stdio` `SSE` `HTTP` |
| 7 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **89** | 35.7k | Playwright MCP server | `web` | `stdio` `SSE` |
...
| 9 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **89** | 2.8k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
...
| 11 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **89** | 19.5k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 17 | [CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext) | █████████░ **88** | 4.0k | An MCP server plus a CLI tool that indexes local code into a graph dat | `data` | `SSE` |
...
| 24 | [tabularis](https://github.com/TabularisDB/tabularis) | █████████░ **87** | 4.0k | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLit | `data` | `stdio` |
...
| 26 | [critical](https://github.com/addyosmani/critical) | █████████░ **87** | 10.3k | Extract & Inline Critical-path CSS in HTML pages | `other` | `stdio` `SSE` |
| 27 | [optillm](https://github.com/algorithmicsuperintelligence/optillm) | █████████░ **87** | 4.2k | Optimizing inference proxy for LLMs | `ai-ml` | `stdio` `SSE` |
| 28 | [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | █████████░ **87** | 15.6k | MCP server to provide Figma layout information to AI coding agents lik | `other` | `stdio` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 63.7k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 838 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 754 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| [hexstrike-ai](https://github.com/0x4m4/hexstrike-ai) | ⭐ 10.7k | 41 | HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, G |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 19.5k | 89 | Context window optimization for AI coding agents. Sandboxes tool output (98% red |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 91.7k | 65 | A collection of MCP servers. |
...
| [inspector](https://github.com/modelcontextprotocol/inspector) | ⭐ 10.6k | 68 | Visual testing tool for MCP servers |
...
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | ⭐ 5.7k | 85 | Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android,  |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 968 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 773 | 0 | An MCP server for interacting with Google Colab |
...
| [nanobanana-mcp-server](https://github.com/zhongweili/nanobanana-mcp-server) | ⭐ 387 | 0 | AI image generation MCP server powered by Google Gemini, with smart model select |
...
| [DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) | ⭐ 9.0k | 84 | This is MCP server for Claude that gives it terminal control, file system search |
...
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.2k | today | 647/651 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | 2d ago | 461/461 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.7k | 3d ago | 137/138 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/253 | **89** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.9k | 4d ago | 106/109 | **89** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.7k | 7d ago | 874/882 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.5k | today | 121/131 | **89** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.8k | 3d ago | 60/63 | **89** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-08-01 09:20 UTC*
