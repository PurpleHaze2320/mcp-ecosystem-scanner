...
> **454** servers catalogued | **10** categories | Last scan: **2026-07-24 09:36 UTC**
...
**Languages:** **TypeScript**: 208 · **Python**: 202 · **Go**: 13 · **JavaScript**: 11 · **Unknown**: 8 · **C#**: 3

**Transports:** `stdio`: 238 · `sse`: 347 · `streamable-http`: 114 · `unknown`: 69
...
| 2 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **90** | 35.5k | Playwright MCP server | `web` | `stdio` `SSE` |
...
| 4 | [notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli) | █████████░ **90** | 5.6k | Programmatic access to Google NotebookLM — via command-line interface  | `productivity` | `SSE` |
| 5 | [ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | █████████░ **90** | 4.1k | The Unofficial and Awesome Home Assistant MCP Server | `dev-tools` | `stdio` `SSE` `HTTP` |
...
| 10 | [ghidra-mcp](https://github.com/bethington/ghidra-mcp) | █████████░ **89** | 2.9k | Ghidra MCP Server — 200+ MCP tools for AI-powered reverse engineering. | `dev-tools` | `stdio` `SSE` `HTTP` |
| 11 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **89** | 19.3k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
| 12 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **89** | 28.6k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
| 13 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 26.8k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 14 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **89** | 10.7k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 16 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **88** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `SSE` `HTTP` |
...
| 21 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **88** | 4.3k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
| 22 | [optillm](https://github.com/algorithmicsuperintelligence/optillm) | █████████░ **88** | 4.2k | Optimizing inference proxy for LLMs | `ai-ml` | `stdio` `SSE` |
...
| 24 | [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | █████████░ **88** | 15.5k | MCP server to provide Figma layout information to AI coding agents lik | `other` | `stdio` |
...
| 26 | [mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | █████████░ **88** | 5.6k | MCP server for Atlassian tools (Confluence, Jira) | `productivity` | `SSE` |
...
| 30 | [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | █████████░ **87** | 12.9k | The official TypeScript SDK for Model Context Protocol servers and cli | `dev-tools` | `stdio` `HTTP` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 62.0k | 87 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [claude-code-ultimate-guide](https://github.com/FlorianBruniaux/claude-code-ultimate-guide) | ⭐ 5.5k | 71 | The most comprehensive Claude Code guide: agentic workflows, hooks, skills, MCP  |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 827 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 749 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| [mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) | ⭐ 620 | 0 | MCP server for interacting with Neon Management API and databases |
| *...and 15 more* | | | |
...
| [hexstrike-ai](https://github.com/0x4m4/hexstrike-ai) | ⭐ 10.5k | 42 | HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, G |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 19.3k | 89 | Context window optimization for AI coding agents. Sandboxes tool output (98% red |
...
| [mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) | ⭐ 669 | 0 | Go server implementing Model Context Protocol (MCP) for filesystem operations. |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 91.3k | 65 | A collection of MCP servers. |
...
| [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | ⭐ 10.7k | 89 | AI-powered reverse engineering assistant that bridges IDA Pro with language mode |
...
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | ⭐ 5.6k | 86 | Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android,  |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [SurfSense](https://github.com/MODSetter/SurfSense) | ⭐ 15.4k | 72 | Open-source NotebookLM alternative. Research the open web with live data(Reddit, |
...
| [NotFair](https://github.com/nowork-studio/NotFair) | ⭐ 3.2k | 77 | Goal-driven, loop-powered marketing agents that crush your business goals 24/7 |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 959 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 740 | 0 | An MCP server for interacting with Google Colab |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 402 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
...
| [mcp-email-server](https://github.com/Wh1isper/mcp-email-server) | ⭐ 289 | 0 | IMAP and SMTP via MCP Server |
| *...and 4 more* | | | |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **private-gpt** | ✅ | ✅ | ✅ | ✅ | ✅ | 57.4k | today | 1240/1242 | **90** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.5k | today | 872/874 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | today | 461/461 | **90** |
| **notebooklm-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.6k | today | 133/134 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.1k | today | 617/628 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.8k | 3d ago | 104/105 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.8k | 2d ago | 60/62 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 236/252 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.5k | 3d ago | 120/128 | **89** |
| **ghidra-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.9k | today | 94/103 | **89** |

---

## 💡 Key Insights

- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 91.3k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-07-24 09:36 UTC*
