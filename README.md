...
> **454** servers catalogued | **10** categories | Last scan: **2026-06-30 10:43 UTC**
...
**Transports:** `stdio`: 236 · `sse`: 347 · `streamable-http`: 113 · `unknown`: 69
...
|------|--------|---------|-------|-------------|----------|-----------|
| 1 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **90** | 34.5k | Playwright MCP server | `web` | `stdio` `SSE` |
| 2 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **90** | 2.7k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
...
| 5 | [ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | █████████░ **90** | 3.7k | The Unofficial and Awesome Home Assistant MCP Server | `dev-tools` | `stdio` `SSE` `HTTP` |
| 6 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **90** | 18.4k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 9 | [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | █████████░ **89** | 15.3k | MCP server to provide Figma layout information to AI coding agents lik | `other` | `stdio` |
| 10 | [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | █████████░ **89** | 6.3k | MCP Server for Computer Use in Windows | `other` | `stdio` `SSE` `HTTP` |
| 11 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 25.9k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 12 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **89** | 3.9k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
...
| 15 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **88** | 28.0k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
...
| 19 | [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | █████████░ **88** | 2.5k | A powerful Model Context Protocol (MCP) server that provides an all-in | `web` | `SSE` |
| 20 | [registry](https://github.com/modelcontextprotocol/registry) | █████████░ **87** | 7.0k | A community driven registry service for Model Context Protocol (MCP) s | `files` | `SSE` |
...
| 24 | [5ire](https://github.com/nanbingxyz/5ire) | █████████░ **87** | 5.3k | 5ire is a cross-platform desktop AI assistant, MCP client. It compatib | `ai-ml` | `SSE` |
...
| 27 | [mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | █████████░ **86** | 5.5k | MCP server for Atlassian tools (Confluence, Jira) | `productivity` | `SSE` |
| 28 | [headroom](https://github.com/headroomlabs-ai/headroom) | █████████░ **85** | 54.3k | Compress tool outputs, logs, files, and RAG chunks before they reach t | `ai-ml` | `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 54.3k | 85 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60 |
...
| [claude-code-ultimate-guide](https://github.com/FlorianBruniaux/claude-code-ultimate-guide) | ⭐ 5.3k | 73 | The most comprehensive Claude Code guide: agentic workflows, hooks, skills, MCP  |
...
| [yargi-mcp](https://github.com/saidsurucu/yargi-mcp) | ⭐ 995 | 0 | MCP Server For Turkish Legal Databases |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 756 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| [mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) | ⭐ 615 | 0 | MCP server for interacting with Neon Management API and databases |
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 600 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
| *...and 15 more* | | | |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 90.0k | 64 | A collection of MCP servers. |
...
| [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | ⭐ 14.4k | 65 | MCP for xiaohongshu.com |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 931 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 700 | 0 | An MCP server for interacting with Google Colab |
...
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 362 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | ⭐ 34.5k | 90 | Playwright MCP server |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 34.5k | today | 862/863 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | today | 59/59 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | yesterday | 461/461 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.7k | yesterday | 102/103 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.7k | today | 514/524 | **90** |
| **context-mode** | ✅ | ✅ | ✅ | ✅ | ✅ | 18.4k | today | 397/409 | **90** |
| **notebooklm-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.1k | 4d ago | 122/122 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.8k | today | 233/250 | **89** |
| **Figma-Context-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 15.3k | 5d ago | 170/176 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.3k | 4d ago | 110/115 | **89** |

---

## 💡 Key Insights

- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 90.0k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-06-30 10:43 UTC*
