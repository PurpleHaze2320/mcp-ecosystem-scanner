...
> **452** servers catalogued | **10** categories | Last scan: **2026-06-05 10:57 UTC**
...
**Languages:** **TypeScript**: 205 · **Python**: 199 · **Go**: 13 · **JavaScript**: 13 · **Unknown**: 8 · **C#**: 4

**Transports:** `stdio`: 235 · `sse`: 346 · `streamable-http`: 112 · `unknown`: 68
...
|------|--------|---------|-------|-------------|----------|-----------|
| 1 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **90** | 33.5k | Playwright MCP server | `web` | `stdio` `SSE` |
...
| 3 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **90** | 16.5k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
| 4 | [mcporter](https://github.com/openclaw/mcporter) | █████████░ **89** | 4.6k | Call MCPs via TypeScript, masquerading as simple TypeScript API. Or pa | `other` | `stdio` `SSE` `HTTP` |
...
| 6 | [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | █████████░ **89** | 5.9k | MCP Server for Computer Use in Windows | `other` | `stdio` `SSE` `HTTP` |
...
| 8 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 25.5k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 9 | [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | █████████░ **89** | 15.0k | MCP server to provide Figma layout information to AI coding agents lik | `other` | `stdio` |
| 10 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **88** | 3.3k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
| 11 | [google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) | █████████░ **88** | 2.6k | Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tas | `productivity` | `stdio` `SSE` `HTTP` |
...
| 13 | [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | █████████░ **88** | 2.4k | A powerful Model Context Protocol (MCP) server that provides an all-in | `web` | `SSE` |
| 14 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **88** | 2.8k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `SSE` `HTTP` |
| 15 | [linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | █████████░ **88** | 2.1k | Open-source MCP server for LinkedIn. Give Claude and any MCP-compatibl | `ai-ml` | `stdio` `HTTP` |
...
| 17 | [csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk) | █████████░ **88** | 4.3k | The official C# SDK for Model Context Protocol servers and clients. Ma | `dev-tools` | `SSE` |
...
| 19 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 9.1k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` `HTTP` |
...
| 23 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **87** | 27.5k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
| 24 | [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | █████████░ **87** | 4.1k | 🤖 A visualization mcp & skills contains 25+ visual charts using @antvi | `ai-ml` | `stdio` `SSE` |
| 25 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **87** | 2.5k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
...
| 28 | [headroom](https://github.com/chopratejas/headroom) | █████████░ **86** | 13.8k | Compress tool outputs, logs, files, and RAG chunks before they reach t | `ai-ml` | `SSE` |
...
| [fastmcp](https://github.com/PrefectHQ/fastmcp) | ⭐ 25.5k | 89 | 🚀 The fast, Pythonic way to build MCP servers and clients. |
...
| [headroom](https://github.com/chopratejas/headroom) | ⭐ 13.8k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60 |
...
| [yargi-mcp](https://github.com/saidsurucu/yargi-mcp) | ⭐ 959 | 0 | MCP Server For Turkish Legal Databases |
...
| [chroma-mcp](https://github.com/chroma-core/chroma-mcp) | ⭐ 557 | 0 | A Model Context Protocol (MCP) server implementation that provides database capa |
| *...and 14 more* | | | |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [TrendRadar](https://github.com/sansan0/TrendRadar) | ⭐ 59.0k | 64 | ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS,  |
...
| [hexstrike-ai](https://github.com/0x4m4/hexstrike-ai) | ⭐ 9.3k | 47 | HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, G |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 16.5k | 90 | Context window optimization for AI coding agents. Sandboxes tool output, 98% red |
...
| [mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) | ⭐ 647 | 0 | Go server implementing Model Context Protocol (MCP) for filesystem operations. |
...
| [mcp-server](https://github.com/mapbox/mcp-server) | ⭐ 344 | 0 | Mapbox Model Context Protocol (MCP) server |
...
| [memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp) | ⭐ 906 | 0 | A Model Context Protocol (MCP) server implementation for remote memory bank mana |

### Other (171 servers)

| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 88.5k | 64 | A collection of MCP servers. |
| [servers](https://github.com/modelcontextprotocol/servers) | ⭐ 86.8k | 72 | Model Context Protocol Servers |
...
| [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | ⭐ 14.0k | 64 | MCP for xiaohongshu.com |
...
| [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | ⭐ 5.9k | 89 | MCP Server for Computer Use in Windows |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 894 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 654 | 0 | An MCP server for interacting with Google Colab |
...
| [Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server) | ⭐ 344 | 0 | A MCP Server for Google Scholar: 🔍 Enable AI assistants to search and access Goo |
| [mcp-email-server](https://github.com/ai-zerolab/mcp-email-server) | ⭐ 249 | 0 | IMAP and SMTP via MCP Server |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | ⭐ 33.5k | 90 | Playwright MCP server |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 33.5k | today | 847/850 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.2k | today | 459/468 | **90** |
| **context-mode** | ✅ | ✅ | ✅ | ✅ | ✅ | 16.5k | today | 341/352 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.6k | 5d ago | 92/93 | **89** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.8k | today | 231/247 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.9k | today | 104/112 | **89** |
| **mcphub** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.1k | today | 293/327 | **89** |
| **fastmcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 25.5k | today | 1395/1624 | **89** |
| **Figma-Context-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 15.0k | 8d ago | 164/174 | **89** |
| **EvoScientist** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.3k | today | 56/66 | **88** |

---

## 💡 Key Insights

- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 88.5k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-06-05 10:57 UTC*
