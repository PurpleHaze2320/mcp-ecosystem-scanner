...
> **455** servers catalogued | **10** categories | Last scan: **2026-07-17 09:23 UTC**
...
**Languages:** **TypeScript**: 208 · **Python**: 203 · **Go**: 13 · **JavaScript**: 11 · **Unknown**: 8 · **C#**: 3

**Transports:** `stdio`: 234 · `sse`: 347 · `streamable-http`: 114 · `unknown`: 70
...
|--------|-------|----------|----------|---------|
| [darknet-mcp-server](https://github.com/badchars/darknet-mcp-server) | ⭐ 236 | TypeScript | `web` | ░░░░░░░░░░ 0 |
...
| 3 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **90** | 35.2k | Playwright MCP server | `web` | `stdio` `SSE` |
| 4 | [notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli) | █████████░ **90** | 5.5k | Programmatic access to Google NotebookLM — via command-line interface  | `productivity` | `SSE` |
...
| 8 | [mcporter](https://github.com/openclaw/mcporter) | █████████░ **90** | 4.8k | Call MCPs via TypeScript, masquerading as simple TypeScript API. Or pa | `other` | `stdio` `SSE` `HTTP` |
| 9 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **90** | 28.4k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
...
| 18 | [google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) | █████████░ **88** | 2.9k | Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tas | `productivity` | `stdio` `SSE` `HTTP` |
...
| 30 | [headroom](https://github.com/headroomlabs-ai/headroom) | █████████░ **86** | 59.6k | Compress tool outputs, logs, files, and RAG chunks before they reach t | `ai-ml` | `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 59.6k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 805 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 734 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| [vexa](https://github.com/Vexa-ai/vexa) | ⭐ 2.6k | 73 | Open-source meeting transcription API for Google Meet, Microsoft Teams & Zoom. A |
...
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 730 | 0 | An MCP server for interacting with Google Colab |
...
| [mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc) | ⭐ 249 | 0 | A Model Context Protocol (MCP) server providing access to Google Search Console |
| *...and 3 more* | | | |
...
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.2k | 2d ago | 865/868 | **90** |
| **notebooklm-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.5k | today | 129/132 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.0k | today | 577/589 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.8k | today | 60/61 | **90** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.4k | today | 120/125 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.8k | 4d ago | 104/104 | **90** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-07-17 09:23 UTC*
