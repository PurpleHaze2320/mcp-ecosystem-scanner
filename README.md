...
> **454** servers catalogued | **10** categories | Last scan: **2026-05-31 10:02 UTC**
...
**Transports:** `stdio`: 236 · `sse`: 345 · `streamable-http`: 113 · `unknown`: 71
...
| 4 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **90** | 16.1k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 10 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **88** | 2.8k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `SSE` `HTTP` |
| 11 | [google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) | █████████░ **88** | 2.5k | Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tas | `productivity` | `stdio` `SSE` `HTTP` |
| 12 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 9.0k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` `HTTP` |
...
| 14 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **88** | 3.3k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
...
| 18 | [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | █████████░ **87** | 4.1k | 🤖 A visualization mcp & skills contains 25+ visual charts using @antvi | `ai-ml` | `stdio` `SSE` |
| 19 | [CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext) | █████████░ **87** | 3.5k | An MCP server plus a CLI tool that indexes local code into a graph dat | `data` | `SSE` |
...
| 28 | [DeepCode](https://github.com/HKUDS/DeepCode) | ████████░░ **84** | 15.8k | "DeepCode: Open Agentic Coding (Paper2Code & Text2Web & Text2Backend)" | `ai-ml` | `stdio` `SSE` |
...
| [yargi-mcp](https://github.com/saidsurucu/yargi-mcp) | ⭐ 938 | 0 | MCP Server For Turkish Legal Databases |
| [supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server) | ⭐ 824 | 0 | Query MCP enables end-to-end management of Supabase via chat interface: read & w |
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 670 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 561 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 16.1k | 90 | Context window optimization for AI coding agents. Sandboxes tool output, 98% red |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 88.2k | 64 | A collection of MCP servers. |
...
| [stitch-skills](https://github.com/google-labs-code/stitch-skills) | ⭐ 5.8k | 67 | A library of Agent Skills designed to work with the Stitch MCP server. Each skil |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 882 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
...
| [mcp-email-server](https://github.com/ai-zerolab/mcp-email-server) | ⭐ 243 | 0 | IMAP and SMTP via MCP Server |
...
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.2k | today | 452/459 | **90** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 33.2k | 3d ago | 844/850 | **90** |
| **context-mode** | ✅ | ✅ | ✅ | ✅ | ✅ | 16.1k | today | 323/339 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.8k | today | 231/247 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.8k | 2d ago | 104/110 | **89** |
| **Figma-Context-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 14.9k | 3d ago | 164/177 | **89** |
| **mcphub** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.1k | today | 286/319 | **89** |
| **fastmcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 25.4k | today | 1394/1611 | **89** |
| **arxiv-mcp-server** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.8k | 12d ago | 46/48 | **88** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-05-31 10:02 UTC*
