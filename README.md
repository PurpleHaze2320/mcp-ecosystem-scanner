...
> **452** servers catalogued | **10** categories | Last scan: **2026-08-08 08:04 UTC**
...
**Transports:** `stdio`: 239 · `sse`: 347 · `streamable-http`: 118 · `unknown`: 65
...
| 3 | [private-gpt](https://github.com/zylon-ai/private-gpt) | █████████░ **90** | 57.4k | Complete API layer for private AI applications on local models: RAG, s | `ai-ml` | `SSE` |
...
| 7 | [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | █████████░ **90** | 6.7k | MCP Server for Computer Use in Windows | `other` | `stdio` `SSE` `HTTP` |
| 8 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **89** | 2.9k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
...
| 11 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 27.1k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
...
| 14 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 11.2k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 21 | [apify-mcp-server](https://github.com/apify/apify-mcp-server) | █████████░ **88** | 2.9k | The Apify MCP server enables your AI agents to extract data from socia | `web` | `stdio` `SSE` `HTTP` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 65.4k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 851 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| [sandbox](https://github.com/agent-infra/sandbox) | ⭐ 5.6k | 66 | All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSC |
...
| [unifi-mcp](https://github.com/sirkirby/unifi-mcp) | ⭐ 652 | 0 | MCP servers for the UniFi suite of applications, Network, Protect, Access, and D |
...
| [servers](https://github.com/modelcontextprotocol/servers) | ⭐ 89.3k | 73 | Model Context Protocol Servers |
...
| [stitch-skills](https://github.com/google-labs-code/stitch-skills) | ⭐ 8.0k | 71 | A library of Agent Skills designed to work with the Stitch MCP server. Each skil |
| [Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH) | ⭐ 7.5k | 51 | MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients |
| [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | ⭐ 6.7k | 90 | MCP Server for Computer Use in Windows |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 976 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 805 | 0 | An MCP server for interacting with Google Colab |
...
| [Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server) | ⭐ 386 | 0 | A MCP Server for Google Scholar: 🔍 Enable AI assistants to search and access Goo |
| [mcp-email-server](https://github.com/Wh1isper/mcp-email-server) | ⭐ 302 | 0 | Full-featured, multi-account MCP email server for Windows, macOS, and Linux—read |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 2.9k | 88 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.9k | today | 874/875 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | today | 461/461 | **90** |
| **private-gpt** | ✅ | ✅ | ✅ | ✅ | ✅ | 57.4k | yesterday | 1241/1241 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.3k | today | 663/667 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.8k | yesterday | 138/140 | **90** |
| **Figma-Context-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 15.6k | yesterday | 170/176 | **90** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.7k | today | 126/132 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.9k | today | 60/64 | **89** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/255 | **89** |
| **ghidra-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.2k | yesterday | 95/105 | **89** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-08-08 08:04 UTC*
