...
> **452** servers catalogued | **10** categories | Last scan: **2026-08-09 08:08 UTC**
...
**Transports:** `stdio`: 239 · `sse`: 348 · `streamable-http`: 118 · `unknown`: 65
...
|------|--------|---------|-------|-------------|----------|-----------|
| 1 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **90** | 35.9k | Playwright MCP server | `web` | `stdio` `SSE` |
| 2 | [gemini-notebook-mcp-cli](https://github.com/jacob-bd/gemini-notebook-mcp-cli) | █████████░ **90** | 5.8k | Programmatic access to Gemini Notebook - via command-line interface (C | `other` | `SSE` |
| 3 | [ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | █████████░ **90** | 4.3k | The Unofficial and Awesome Home Assistant MCP Server | `dev-tools` | `stdio` `SSE` `HTTP` |
...
| 5 | [private-gpt](https://github.com/zylon-ai/private-gpt) | █████████░ **90** | 57.4k | Complete API layer for private AI applications on local models: RAG, s | `ai-ml` | `SSE` |
| 6 | [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | █████████░ **90** | 15.6k | MCP server to provide Figma layout information to AI coding agents lik | `other` | `stdio` |
| 7 | [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | █████████░ **89** | 6.7k | MCP Server for Computer Use in Windows | `other` | `stdio` `SSE` `HTTP` |
...
| 10 | [ghidra-mcp](https://github.com/bethington/ghidra-mcp) | █████████░ **89** | 3.2k | Ghidra MCP Server — 200+ MCP tools for AI-powered reverse engineering. | `dev-tools` | `stdio` `SSE` `HTTP` |
| 11 | [critical](https://github.com/addyosmani/critical) | █████████░ **89** | 10.3k | Extract & Inline Critical-path CSS in HTML pages | `other` | `stdio` `SSE` |
| 12 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **88** | 27.1k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 13 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **88** | 19.7k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 15 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 11.2k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 18 | [python-sdk](https://github.com/modelcontextprotocol/python-sdk) | █████████░ **88** | 23.9k | The official Python SDK for Model Context Protocol servers and clients | `dev-tools` | `stdio` `SSE` `HTTP` |
...
| 20 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **88** | 4.6k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
| 21 | [apify-mcp-server](https://github.com/apify/apify-mcp-server) | █████████░ **88** | 3.0k | The Apify MCP server enables your AI agents to extract data from socia | `web` | `stdio` `SSE` `HTTP` |
| 22 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **88** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `HTTP` |
...
| 25 | [mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | █████████░ **87** | 5.7k | MCP server for Atlassian tools (Confluence, Jira) | `productivity` | `SSE` |
| 26 | [tabularis](https://github.com/TabularisDB/tabularis) | █████████░ **87** | 4.0k | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLit | `data` | `stdio` |
| 27 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **87** | 28.9k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
| 28 | [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | █████████░ **87** | 5.8k | Model Context Protocol Server for Mobile Automation and Scraping (iOS, | `other` | `stdio` `SSE` |
| 29 | [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | █████████░ **87** | 13.1k | The official TypeScript SDK for Model Context Protocol servers and cli | `dev-tools` | `stdio` `HTTP` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 65.6k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [fastmcp](https://github.com/PrefectHQ/fastmcp) | ⭐ 27.1k | 88 | 🚀 The fast, Pythonic way to build MCP servers and clients. |
...
| [sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers) | ⭐ 241 | 0 | Sample implementations of AI Agents and MCP Servers running on AWS Serverless co |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 850 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 19.7k | 88 | Context window optimization for AI coding agents. Sandboxes tool output (98% red |
...
| [unifi-mcp](https://github.com/sirkirby/unifi-mcp) | ⭐ 655 | 0 | MCP servers for the UniFi suite of applications, Network, Protect, Access, and D |
...
| [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | ⭐ 15.6k | 90 | MCP server to provide Figma layout information to AI coding agents like Cursor |
| [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | ⭐ 15.1k | 74 | MCP for xiaohongshu.com |
| [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | ⭐ 11.2k | 88 | AI-powered reverse engineering assistant that bridges IDA Pro with language mode |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 977 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 809 | 0 | An MCP server for interacting with Google Colab |
...
| [mcp-email-server](https://github.com/Wh1isper/mcp-email-server) | ⭐ 304 | 0 | Full-featured, multi-account MCP email server for Windows, macOS, and Linux—read |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | ⭐ 35.9k | 90 | Playwright MCP server |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 3.0k | 88 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
| [LetsFG](https://github.com/LetsFG/LetsFG) | ⭐ 1.6k | 0 | Agent-native flight & hotel search and booking — MCP server, CLI, and Python/JS  |
| *...and 36 more* | | | |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.9k | yesterday | 874/876 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.8k | today | 140/141 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.3k | today | 664/668 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | yesterday | 461/461 | **90** |
| **private-gpt** | ✅ | ✅ | ✅ | ✅ | ✅ | 57.4k | 2d ago | 1241/1241 | **90** |
| **Figma-Context-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 15.6k | 2d ago | 170/176 | **90** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.7k | today | 126/134 | **89** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/255 | **89** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.9k | yesterday | 60/64 | **89** |
| **ghidra-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.2k | 2d ago | 95/105 | **89** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-08-09 08:08 UTC*
