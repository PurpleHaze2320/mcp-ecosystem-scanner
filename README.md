...
> **452** servers catalogued | **10** categories | Last scan: **2026-08-03 10:53 UTC**
...
**Transports:** `stdio`: 240 · `sse`: 345 · `streamable-http`: 118 · `unknown`: 67
...
| 4 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **90** | 2.9k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
| 5 | [gemini-notebook-mcp-cli](https://github.com/jacob-bd/gemini-notebook-mcp-cli) | █████████░ **89** | 5.7k | Programmatic access to Gemini Notebook - via command-line interface (C | `other` | `SSE` |
...
| 7 | [critical](https://github.com/addyosmani/critical) | █████████░ **89** | 10.3k | Extract & Inline Critical-path CSS in HTML pages | `other` | `stdio` `SSE` |
...
| 9 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **89** | 35.8k | Playwright MCP server | `web` | `stdio` `SSE` |
...
| 11 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 27.0k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 12 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **89** | 19.6k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 15 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 11.0k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 17 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **88** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `HTTP` |
...
| 20 | [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | █████████░ **88** | 2.6k | A powerful Model Context Protocol (MCP) server that provides an all-in | `web` | `SSE` |
| 21 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **88** | 28.8k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
...
| 26 | [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | █████████░ **87** | 5.8k | Model Context Protocol Server for Mobile Automation and Scraping (iOS, | `other` | `stdio` `SSE` |
...
| 28 | [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | █████████░ **87** | 13.0k | The official TypeScript SDK for Model Context Protocol servers and cli | `dev-tools` | `stdio` `HTTP` |
| 29 | [optillm](https://github.com/algorithmicsuperintelligence/optillm) | █████████░ **87** | 4.2k | Optimizing inference proxy for LLMs | `ai-ml` | `stdio` `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 64.2k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [mcp](https://github.com/cloudflare/mcp) | ⭐ 692 | 0 | MCP server for the Cloudflare API |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 840 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| [hexstrike-ai](https://github.com/0x4m4/hexstrike-ai) | ⭐ 10.8k | 40 | HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, G |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 91.8k | 65 | A collection of MCP servers. |
...
| [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | ⭐ 15.0k | 74 | MCP for xiaohongshu.com |
...
| [gemini-notebook-mcp-cli](https://github.com/jacob-bd/gemini-notebook-mcp-cli) | ⭐ 5.7k | 89 | Programmatic access to Gemini Notebook - via command-line interface (CLI), Model |
| *...and 147 more* | | | |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 972 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 783 | 0 | An MCP server for interacting with Google Colab |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 411 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | ⭐ 35.8k | 89 | Playwright MCP server |
...
| [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | ⭐ 2.6k | 88 | A powerful Model Context Protocol (MCP) server that provides an all-in-one solut |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 2.5k | 0 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.2k | today | 649/656 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.9k | today | 60/63 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.7k | 5d ago | 137/138 | **89** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/254 | **89** |
| **critical** | ✅ | ✅ | ✅ | ✅ | ✅ | 10.3k | today | 330/364 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.6k | yesterday | 121/131 | **89** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.8k | 9d ago | 874/882 | **89** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-08-03 10:53 UTC*
