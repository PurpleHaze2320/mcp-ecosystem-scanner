...
> **454** servers catalogued | **10** categories | Last scan: **2026-07-01 10:57 UTC**
...
**Transports:** `stdio`: 237 · `sse`: 347 · `streamable-http`: 114 · `unknown`: 68
...
| 3 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **90** | 34.6k | Playwright MCP server | `web` | `stdio` `SSE` |
| 4 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **90** | 2.7k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
| 5 | [notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli) | █████████░ **90** | 5.1k | Programmatic access to Google NotebookLM — via command-line interface  | `productivity` | `SSE` |
| 6 | [ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | █████████░ **90** | 3.7k | The Unofficial and Awesome Home Assistant MCP Server | `dev-tools` | `stdio` `SSE` `HTTP` |
| 7 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **90** | 18.4k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 12 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **88** | 25.9k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
...
| 14 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 9.8k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 16 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **88** | 28.0k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
...
| 18 | [linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | █████████░ **88** | 2.6k | Open-source MCP server for LinkedIn. Give Claude and any MCP-compatibl | `ai-ml` | `stdio` `SSE` `HTTP` |
| 19 | [registry](https://github.com/modelcontextprotocol/registry) | █████████░ **88** | 7.0k | A community driven registry service for Model Context Protocol (MCP) s | `files` | `SSE` |
...
| 22 | [tabularis](https://github.com/TabularisDB/tabularis) | █████████░ **87** | 3.5k | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLit | `data` | `stdio` |
| 23 | [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | █████████░ **87** | 12.8k | The official TypeScript SDK for Model Context Protocol servers and cli | `dev-tools` | `stdio` `HTTP` |
...
| 26 | [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | █████████░ **86** | 5.3k | Model Context Protocol Server for Mobile Automation and Scraping (iOS, | `other` | `stdio` `SSE` |
| 27 | [headroom](https://github.com/headroomlabs-ai/headroom) | █████████░ **86** | 55.0k | Compress tool outputs, logs, files, and RAG chunks before they reach t | `ai-ml` | `SSE` |
...
| 29 | [CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext) | █████████░ **85** | 3.8k | An MCP server plus a CLI tool that indexes local code into a graph dat | `data` | `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 55.0k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60 |
...
| [Qwen-Agent](https://github.com/QwenLM/Qwen-Agent) | ⭐ 16.6k | 72 | Agent framework and applications built upon Qwen>=3.0, featuring Function Callin |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext) | ⭐ 3.8k | 85 | An MCP server plus a CLI tool that indexes local code into a graph database to p |
| [tabularis](https://github.com/TabularisDB/tabularis) | ⭐ 3.5k | 87 | Open-source desktop SQL workspace for PostgreSQL, MySQL/MariaDB, SQLite and 12+  |
...
| [yargi-mcp](https://github.com/saidsurucu/yargi-mcp) | ⭐ 997 | 0 | MCP Server For Turkish Legal Databases |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 758 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 623 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [TrendRadar](https://github.com/sansan0/TrendRadar) | ⭐ 60.1k | 64 | ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS,  |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 18.4k | 90 | Context window optimization for AI coding agents. Sandboxes tool output (98% red |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 90.1k | 64 | A collection of MCP servers. |
| [servers](https://github.com/modelcontextprotocol/servers) | ⭐ 87.9k | 72 | Model Context Protocol Servers |
...
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 701 | 0 | An MCP server for interacting with Google Colab |
| [nanobanana-mcp-server](https://github.com/zhongweili/nanobanana-mcp-server) | ⭐ 369 | 0 | AI image generation MCP server powered by Google Gemini, with smart model select |
| [Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server) | ⭐ 368 | 0 | A MCP Server for Google Scholar: 🔍 Enable AI assistants to search and access Goo |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 363 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
...
| [anything-analyzer](https://github.com/Mouseww/anything-analyzer) | ⭐ 3.2k | 76 | 全能协议分析工具：浏览器抓包 + MITM 代理 + 指纹伪装 + AI 分析 + MCP Server 无缝对接 AI Agent/IDE   |  All- |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.7k | today | 103/103 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | today | 461/461 | **90** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 34.6k | yesterday | 862/863 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | yesterday | 59/59 | **90** |
| **notebooklm-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.1k | today | 122/124 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.7k | today | 517/526 | **90** |
| **context-mode** | ✅ | ✅ | ✅ | ✅ | ✅ | 18.4k | today | 397/409 | **90** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.3k | today | 110/115 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.8k | today | 234/250 | **89** |
| **Figma-Context-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 15.3k | 6d ago | 170/176 | **89** |

---

## 💡 Key Insights

- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 90.1k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-07-01 10:57 UTC*
