...
> **455** servers catalogued | **10** categories | Last scan: **2026-09-05 11:20 UTC**
...
| [reverify](https://github.com/2akouwu/reverify) | ⭐ 911 | Python | `dev-tools` | ░░░░░░░░░░ 0 |
...
| 5 | [drawio-skill](https://github.com/Agents365-ai/drawio-skill) | █████████░ **90** | 9.1k | From text & real sources to maintainable .drawio architecture models:  | `dev-tools` | `SSE` |
...
| 13 | [worldmonitor](https://github.com/koala73/worldmonitor) | █████████░ **89** | 85.6k | Real-time global intelligence dashboard. AI-powered news aggregation,  | `other` | `HTTP` |
| 14 | [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | █████████░ **89** | 4.4k | 🤖 A visualization mcp & skills contains 25+ visual charts using @antvi | `ai-ml` | `stdio` `SSE` |
| 15 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **89** | 29.3k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
...
| 21 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 11.8k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
| 22 | [core](https://github.com/opensumi/core) | █████████░ **88** | 3.7k | A framework helps you quickly build AI Native IDE products. MCP Client | `other` | — |
| 23 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **88** | 20.4k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 26 | [apify-mcp-server](https://github.com/apify/apify-mcp-server) | █████████░ **88** | 6.0k | The Apify MCP server enables your AI agents to extract data from socia | `web` | `stdio` `SSE` `HTTP` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 69.0k | 87 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [mcp](https://github.com/cloudflare/mcp) | ⭐ 807 | 0 | MCP server for the Cloudflare API |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 20.4k | 88 | Context window optimization for AI coding agents. Sandboxes tool output (98% red |
...
| [unifi-mcp](https://github.com/sirkirby/unifi-mcp) | ⭐ 782 | 0 | MCP servers for the UniFi suite of applications, Network, Protect, Access, and D |
| [mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) | ⭐ 682 | 0 | Go server implementing Model Context Protocol (MCP) for filesystem operations. |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 94.2k | 64 | A collection of MCP servers. |
| [servers](https://github.com/modelcontextprotocol/servers) | ⭐ 90.1k | 73 | Model Context Protocol Servers |
| [worldmonitor](https://github.com/koala73/worldmonitor) | ⭐ 85.6k | 89 | Real-time global intelligence dashboard. AI-powered news aggregation, geopolitic |
...
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 931 | 0 | An MCP server for interacting with Google Colab |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 6.0k | 88 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 36.8k | today | 882/884 | **90** |
| **private-gpt** | ✅ | ✅ | ✅ | ✅ | ✅ | 57.5k | yesterday | 1241/1243 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.0k | yesterday | 157/157 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.6k | today | 715/725 | **90** |
| **drawio-skill** | ✅ | ✅ | ✅ | ✅ | ✅ | 9.1k | 2d ago | 18/18 | **90** |
| **Figma-Context-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 15.8k | today | 170/176 | **90** |
| **agent-device** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.4k | today | 575/616 | **89** |
...
- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 94.2k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-09-05 11:20 UTC*
