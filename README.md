...
> **456** servers catalogued | **10** categories | Last scan: **2026-09-02 12:09 UTC**
...
**Transports:** `stdio`: 249 · `sse`: 352 · `streamable-http`: 125 · `unknown`: 65
...
| 8 | [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | █████████░ **89** | 6.9k | MCP Server for Computer Use in Windows | `other` | `stdio` `SSE` `HTTP` |
| 9 | [ouroboros](https://github.com/Q00/ouroboros) | █████████░ **89** | 5.8k | Agent OS: the agent gets smarter on its own. We just hold the line: th | `ai-ml` | `SSE` |
...
| 13 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **89** | 29.3k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
| 14 | [worldmonitor](https://github.com/koala73/worldmonitor) | █████████░ **89** | 85.4k | Real-time global intelligence dashboard. AI-powered news aggregation,  | `other` | `HTTP` |
| 15 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **88** | 27.5k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 16 | [python-sdk](https://github.com/modelcontextprotocol/python-sdk) | █████████░ **88** | 24.2k | The official Python SDK for Model Context Protocol servers and clients | `dev-tools` | `stdio` `SSE` `HTTP` |
| 17 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 11.8k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 19 | [CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext) | █████████░ **88** | 4.2k | An MCP server plus a CLI tool that indexes local code into a graph dat | `data` | `SSE` |
...
| 22 | [csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk) | █████████░ **88** | 4.5k | The official C# SDK for Model Context Protocol servers and clients. Ma | `dev-tools` | `SSE` |
...
| 26 | [apify-mcp-server](https://github.com/apify/apify-mcp-server) | █████████░ **88** | 5.7k | The Apify MCP server enables your AI agents to extract data from socia | `web` | `stdio` `SSE` `HTTP` |
...
| 29 | [headroom](https://github.com/headroomlabs-ai/headroom) | █████████░ **87** | 68.4k | Compress tool outputs, logs, files, and RAG chunks before they reach t | `ai-ml` | `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 68.4k | 87 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [mcp](https://github.com/cloudflare/mcp) | ⭐ 787 | 0 | MCP server for the Cloudflare API |
| [mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops) | ⭐ 384 | 0 | An MCP server for Azure DevOps |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 892 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 776 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| [strix](https://github.com/usestrix/strix) | ⭐ 60.1k | 86 | Open-source AI penetration testing tool to find and fix your app’s vulnerabiliti |
...
| [drawio-skill](https://github.com/Agents365-ai/drawio-skill) | ⭐ 9.0k | 90 | From text & real sources to maintainable .drawio architecture models: Diagram IR |
...
| [unifi-mcp](https://github.com/sirkirby/unifi-mcp) | ⭐ 774 | 0 | MCP servers for the UniFi suite of applications, Network, Protect, Access, and D |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 93.8k | 65 | A collection of MCP servers. |
| [servers](https://github.com/modelcontextprotocol/servers) | ⭐ 90.0k | 73 | Model Context Protocol Servers |
| [worldmonitor](https://github.com/koala73/worldmonitor) | ⭐ 85.4k | 89 | Real-time global intelligence dashboard. AI-powered news aggregation, geopolitic |
...
| [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | ⭐ 11.8k | 88 | AI-powered reverse engineering assistant that bridges IDA Pro with language mode |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 994 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
...
| [google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server) | ⭐ 209 | 0 | MCP server for Google Tag Manager |
| *...and 2 more* | | | |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 5.7k | 88 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 36.7k | yesterday | 880/882 | **90** |
| **drawio-skill** | ✅ | ✅ | ✅ | ✅ | ✅ | 9.0k | yesterday | 18/18 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.6k | today | 709/716 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.0k | 5d ago | 157/157 | **90** |
| **agent-device** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.3k | today | 566/605 | **89** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.0k | today | 67/71 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.9k | today | 132/144 | **89** |
| **ouroboros** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.8k | yesterday | 718/772 | **89** |
| **mcp-server-chart** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.3k | 6d ago | 172/176 | **89** |

---

## 💡 Key Insights

- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 93.8k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-09-02 12:09 UTC*
