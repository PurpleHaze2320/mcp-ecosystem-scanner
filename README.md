...
> **452** servers catalogued | **10** categories | Last scan: **2026-08-02 09:20 UTC**
...
**Transports:** `stdio`: 240 · `sse`: 346 · `streamable-http`: 118 · `unknown`: 66
...
| 2 | [ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | █████████░ **90** | 4.2k | The Unofficial and Awesome Home Assistant MCP Server | `dev-tools` | `stdio` `SSE` `HTTP` |
...
| 4 | [mcporter](https://github.com/openclaw/mcporter) | █████████░ **90** | 4.9k | Call MCPs via TypeScript, masquerading as simple TypeScript API. Or pa | `other` | `stdio` `SSE` `HTTP` |
| 5 | [gemini-notebook-mcp-cli](https://github.com/jacob-bd/gemini-notebook-mcp-cli) | █████████░ **90** | 5.7k | Programmatic access to Gemini Notebook - via command-line interface (C | `other` | `SSE` |
...
| 7 | [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | █████████░ **89** | 6.6k | MCP Server for Computer Use in Windows | `other` | `stdio` `SSE` `HTTP` |
| 8 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **89** | 35.7k | Playwright MCP server | `web` | `stdio` `SSE` |
...
| 10 | [ghidra-mcp](https://github.com/bethington/ghidra-mcp) | █████████░ **89** | 3.1k | Ghidra MCP Server — 200+ MCP tools for AI-powered reverse engineering. | `dev-tools` | `stdio` `SSE` `HTTP` |
| 11 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **89** | 19.6k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
| 12 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **88** | 27.0k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
| 13 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **88** | 11.0k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 15 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **88** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `HTTP` |
| 16 | [CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext) | █████████░ **88** | 4.0k | An MCP server plus a CLI tool that indexes local code into a graph dat | `data` | `SSE` |
...
| 18 | [python-sdk](https://github.com/modelcontextprotocol/python-sdk) | █████████░ **88** | 23.8k | The official Python SDK for Model Context Protocol servers and clients | `dev-tools` | `stdio` `SSE` `HTTP` |
| 19 | [EvoScientist](https://github.com/EvoScientist/EvoScientist) | █████████░ **88** | 4.5k | 🔬 Harness Vibe Research with Self-evolving AI Scientists | `dev-tools` | `SSE` |
| 20 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **88** | 28.8k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
| 21 | [registry](https://github.com/modelcontextprotocol/registry) | █████████░ **88** | 7.1k | A community driven registry service for Model Context Protocol (MCP) s | `files` | `SSE` |
| 22 | [linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | █████████░ **88** | 3.0k | Open-source MCP server for LinkedIn. Give Claude and any MCP-compatibl | `ai-ml` | `stdio` `SSE` `HTTP` |
...
| 26 | [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | █████████░ **87** | 5.7k | Model Context Protocol Server for Mobile Automation and Scraping (iOS, | `other` | `stdio` `SSE` |
| 27 | [critical](https://github.com/addyosmani/critical) | █████████░ **87** | 10.3k | Extract & Inline Critical-path CSS in HTML pages | `other` | `stdio` `SSE` |
| 28 | [optillm](https://github.com/algorithmicsuperintelligence/optillm) | █████████░ **87** | 4.2k | Optimizing inference proxy for LLMs | `ai-ml` | `stdio` `SSE` |
...
| 30 | [mcp-context-forge](https://github.com/IBM/mcp-context-forge) | █████████░ **87** | 4.2k | An AI Gateway, registry, and proxy that sits in front of any MCP, A2A, | `dev-tools` | `stdio` `SSE` `HTTP` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 64.0k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [fastmcp](https://github.com/PrefectHQ/fastmcp) | ⭐ 27.0k | 88 | 🚀 The fast, Pythonic way to build MCP servers and clients. |
...
| [awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills) | ⭐ 6.0k | 35 | Tutorials, Guides and Agent Skills Directories |
...
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | ⭐ 4.3k | 81 | 🤖 A visualization mcp & skills contains 25+ visual charts using @antvis. Using f |
| *...and 64 more* | | | |
...
| [dbhub](https://github.com/bytebase/dbhub) | ⭐ 3.3k | 75 | Token efficient, zero-dependency database MCP server for Postgres, MySQL, SQL Se |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 839 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 753 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [TrendRadar](https://github.com/sansan0/TrendRadar) | ⭐ 61.1k | 63 | ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS,  |
| [python-sdk](https://github.com/modelcontextprotocol/python-sdk) | ⭐ 23.8k | 88 | The official Python SDK for Model Context Protocol servers and clients |
...
| [hexstrike-ai](https://github.com/0x4m4/hexstrike-ai) | ⭐ 10.8k | 41 | HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, G |
| [modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol) | ⭐ 8.8k | 74 | Specification and documentation for the Model Context Protocol |
...
| [ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | ⭐ 4.2k | 90 | The Unofficial and Awesome Home Assistant MCP Server |
...
| [mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) | ⭐ 672 | 0 | Go server implementing Model Context Protocol (MCP) for filesystem operations. |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 91.7k | 64 | A collection of MCP servers. |
| [servers](https://github.com/modelcontextprotocol/servers) | ⭐ 89.1k | 73 | Model Context Protocol Servers |
| [activepieces](https://github.com/activepieces/activepieces) | ⭐ 23.5k | 74 | AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • A |
| [aisuite](https://github.com/andrewyng/aisuite) | ⭐ 15.9k | 82 | Simple, unified interface to multiple Generative AI providers  |
| [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | ⭐ 15.6k | 87 | MCP server to provide Figma layout information to AI coding agents like Cursor |
| [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | ⭐ 15.0k | 73 | MCP for xiaohongshu.com |
| [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | ⭐ 11.0k | 88 | AI-powered reverse engineering assistant that bridges IDA Pro with language mode |
...
| [stitch-skills](https://github.com/google-labs-code/stitch-skills) | ⭐ 7.9k | 72 | A library of Agent Skills designed to work with the Stitch MCP server. Each skil |
...
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | ⭐ 5.7k | 87 | Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android,  |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [SurfSense](https://github.com/MODSetter/SurfSense) | ⭐ 15.7k | 72 | Open-source NotebookLM alternative. Research the open web with live data(Reddit, |
| [mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | ⭐ 5.7k | 88 | MCP server for Atlassian tools (Confluence, Jira) |
| [NotFair](https://github.com/nowork-studio/NotFair) | ⭐ 3.3k | 75 | Goal-driven, loop-powered marketing agents that crush your business goals 24/7 |
...
| [mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) | ⭐ 970 | 0 | This MCP server integrates with your Google Drive and Google Sheets, to enable c |
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 775 | 0 | An MCP server for interacting with Google Colab |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 407 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
| [nanobanana-mcp-server](https://github.com/zhongweili/nanobanana-mcp-server) | ⭐ 388 | 0 | AI image generation MCP server powered by Google Gemini, with smart model select |
| [Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server) | ⭐ 383 | 0 | A MCP Server for Google Scholar: 🔍 Enable AI assistants to search and access Goo |
| [mcp-email-server](https://github.com/Wh1isper/mcp-email-server) | ⭐ 299 | 0 | IMAP and SMTP via MCP Server |
| [mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc) | ⭐ 255 | 0 | A Model Context Protocol (MCP) server providing access to Google Search Console |
| *...and 3 more* | | | |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | ⭐ 35.7k | 89 | Playwright MCP server |
...
| [DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) | ⭐ 9.1k | 84 | This is MCP server for Claude that gives it terminal control, file system search |
...
| [bb-browser](https://github.com/epiral/bb-browser) | ⭐ 6.0k | 63 | Your browser is the API. CLI + MCP server for AI agents to control Chrome with y |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 2.4k | 0 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.2k | today | 648/652 | **90** |
| **private-gpt** | ✅ | ✅ | ✅ | ✅ | ✅ | 57.4k | 2d ago | 1241/1241 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.9k | today | 106/109 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.7k | 4d ago | 137/138 | **90** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/253 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.6k | today | 121/131 | **89** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.7k | 8d ago | 874/882 | **89** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.9k | 4d ago | 60/63 | **89** |
...
- **Most popular**: [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) with 91.7k stars
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-08-02 09:20 UTC*
