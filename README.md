...
> **452** servers catalogued | **10** categories | Last scan: **2026-08-06 09:52 UTC**
...
| 2 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **90** | 35.9k | Playwright MCP server | `web` | `stdio` `SSE` |
...
| 6 | [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | █████████░ **90** | 6.6k | MCP Server for Computer Use in Windows | `other` | `stdio` `SSE` `HTTP` |
| 7 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **89** | 2.9k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
...
| 9 | [ghidra-mcp](https://github.com/bethington/ghidra-mcp) | █████████░ **89** | 3.2k | Ghidra MCP Server — 200+ MCP tools for AI-powered reverse engineering. | `dev-tools` | `stdio` `SSE` `HTTP` |
...
| 12 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **89** | 19.7k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
| 13 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **89** | 11.1k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
...
| 20 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **88** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `HTTP` |
| 21 | [apify-mcp-server](https://github.com/apify/apify-mcp-server) | █████████░ **88** | 2.7k | The Apify MCP server enables your AI agents to extract data from socia | `web` | `stdio` `SSE` `HTTP` |
...
| 24 | [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | █████████░ **88** | 28.9k | An autonomous agent that conducts deep research on any data using any  | `ai-ml` | `SSE` |
...
| 30 | [optillm](https://github.com/algorithmicsuperintelligence/optillm) | █████████░ **86** | 4.2k | Optimizing inference proxy for LLMs | `ai-ml` | `stdio` `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 65.1k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | ⭐ 28.9k | 88 | An autonomous agent that conducts deep research on any data using any LLM provid |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 849 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 19.7k | 89 | Context window optimization for AI coding agents. Sandboxes tool output (98% red |
...
| [unifi-mcp](https://github.com/sirkirby/unifi-mcp) | ⭐ 646 | 0 | MCP servers for the UniFi suite of applications, Network, Protect, Access, and D |
...
| [Windows-MCP](https://github.com/CursorTouch/Windows-MCP) | ⭐ 6.6k | 90 | MCP Server for Computer Use in Windows |
...
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 797 | 0 | An MCP server for interacting with Google Colab |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 415 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | ⭐ 2.7k | 88 | The Apify MCP server enables your AI agents to extract data from social media, s |
...
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.9k | today | 880/881 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | today | 461/461 | **90** |
| **gemini-notebook-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.8k | today | 138/139 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.3k | today | 660/665 | **90** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.6k | today | 126/132 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.9k | today | 60/64 | **89** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 237/255 | **89** |
| **ghidra-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.2k | yesterday | 95/105 | **89** |
| **critical** | ✅ | ✅ | ✅ | ✅ | ✅ | 10.3k | 3d ago | 330/364 | **89** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-08-06 09:52 UTC*
