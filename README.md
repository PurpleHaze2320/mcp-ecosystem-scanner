...
> **452** servers catalogued | **10** categories | Last scan: **2026-08-04 09:50 UTC**
...
**Transports:** `stdio`: 241 · `sse`: 346 · `streamable-http`: 119 · `unknown`: 66
...
| 6 | [agent-scan](https://github.com/snyk/agent-scan) | █████████░ **90** | 2.9k | Security scanner for AI agents, MCP servers and agent skills. | `other` | `stdio` `SSE` |
...
| 13 | [context-mode](https://github.com/mksglu/context-mode) | █████████░ **88** | 19.6k | Context window optimization for AI coding agents. Sandboxes tool outpu | `files` | `stdio` `SSE` |
...
| 18 | [arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) | █████████░ **88** | 3.0k | A Model Context Protocol server for searching and analyzing arXiv pape | `ai-ml` | `stdio` `HTTP` |
...
| 20 | [linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | █████████░ **88** | 3.0k | Open-source MCP server for LinkedIn. Give Claude and any MCP-compatibl | `ai-ml` | `stdio` `SSE` `HTTP` |
| 21 | [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | █████████░ **88** | 2.6k | A powerful Model Context Protocol (MCP) server that provides an all-in | `web` | `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 64.5k | 86 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 841 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
...
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 755 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [TrendRadar](https://github.com/sansan0/TrendRadar) | ⭐ 61.2k | 63 | ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS,  |
...
| Server | Stars | Quality | Description |
|--------|-------|---------|-------------|
| [context-mode](https://github.com/mksglu/context-mode) | ⭐ 19.6k | 88 | Context window optimization for AI coding agents. Sandboxes tool output (98% red |
...
| [colab-mcp](https://github.com/googlecolab/colab-mcp) | ⭐ 786 | 0 | An MCP server for interacting with Google Colab |
| [mcp-google-map](https://github.com/cablate/mcp-google-map) | ⭐ 412 | 0 | A powerful Model Context Protocol (MCP) server providing comprehensive Google Ma |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-08-04 09:50 UTC*
