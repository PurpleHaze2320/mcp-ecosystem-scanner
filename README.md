...
> **454** servers catalogued | **10** categories | Last scan: **2026-07-20 10:15 UTC**
...
|--------|-------|----------|----------|---------|
| [darknet-mcp-server](https://github.com/badchars/darknet-mcp-server) | ⭐ 256 | TypeScript | `web` | ░░░░░░░░░░ 0 |
...
| 3 | [ha-mcp](https://github.com/homeassistant-ai/ha-mcp) | █████████░ **90** | 4.0k | The Unofficial and Awesome Home Assistant MCP Server | `dev-tools` | `stdio` `SSE` `HTTP` |
| 4 | [mcporter](https://github.com/openclaw/mcporter) | █████████░ **90** | 4.8k | Call MCPs via TypeScript, masquerading as simple TypeScript API. Or pa | `other` | `stdio` `SSE` `HTTP` |
...
| 7 | [playwright-mcp](https://github.com/microsoft/playwright-mcp) | █████████░ **89** | 35.3k | Playwright MCP server | `web` | `stdio` `SSE` |
...
| 12 | [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | █████████░ **89** | 10.5k | AI-powered reverse engineering assistant that bridges IDA Pro with lan | `other` | `stdio` `SSE` |
| 13 | [fastmcp](https://github.com/PrefectHQ/fastmcp) | █████████░ **89** | 26.3k | 🚀 The fast, Pythonic way to build MCP servers and clients. | `ai-ml` | `SSE` |
...
| 16 | [critical](https://github.com/addyosmani/critical) | █████████░ **88** | 10.2k | Extract & Inline Critical-path CSS in HTML pages | `other` | `stdio` `SSE` |
...
| 18 | [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | █████████░ **88** | 15.4k | MCP server to provide Figma layout information to AI coding agents lik | `other` | `stdio` |
| 19 | [google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) | █████████░ **88** | 2.9k | Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tas | `productivity` | `stdio` `SSE` `HTTP` |
...
| 21 | [linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server) | █████████░ **88** | 2.8k | Open-source MCP server for LinkedIn. Give Claude and any MCP-compatibl | `ai-ml` | `stdio` `SSE` `HTTP` |
...
| 24 | [5ire](https://github.com/nanbingxyz/5ire) | █████████░ **88** | 5.3k | 5ire is a cross-platform desktop AI assistant, MCP client. It compatib | `ai-ml` | `SSE` |
| 25 | [registry](https://github.com/modelcontextprotocol/registry) | █████████░ **87** | 7.0k | A community driven registry service for Model Context Protocol (MCP) s | `files` | `SSE` |
...
| 29 | [headroom](https://github.com/headroomlabs-ai/headroom) | █████████░ **87** | 60.5k | Compress tool outputs, logs, files, and RAG chunks before they reach t | `ai-ml` | `SSE` |
...
|--------|-------|---------|-------------|
| [headroom](https://github.com/headroomlabs-ai/headroom) | ⭐ 60.5k | 87 | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 20 |
...
| [mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry) | ⭐ 813 | 0 | Enterprise-ready MCP Gateway & Registry that centralizes AI development tools wi |
| [mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub) | ⭐ 742 | 0 | A growing collection of MCP servers bringing offensive security tools to AI assi |
...
| [OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server) | ⭐ 171 | 0 | Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and  |
...
| [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | ⭐ 10.5k | 89 | AI-powered reverse engineering assistant that bridges IDA Pro with language mode |
...
| [Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH) | ⭐ 7.5k | 53 | MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients |
...
|--------|:------:|:-------:|:-----:|:--:|:--------:|:-----:|:-------:|:------:|:---------:|
| **private-gpt** | ✅ | ✅ | ✅ | ✅ | ✅ | 57.3k | today | 1237/1241 | **90** |
| **semiotic** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.7k | today | 461/461 | **90** |
| **ha-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.0k | today | 605/613 | **90** |
| **mcporter** | ✅ | ✅ | ✅ | ✅ | ✅ | 4.8k | yesterday | 104/105 | **90** |
| **notebooklm-mcp-cli** | ✅ | ✅ | ✅ | ✅ | ✅ | 5.5k | 2d ago | 130/132 | **90** |
| **agent-scan** | ✅ | ✅ | ✅ | ✅ | ✅ | 2.8k | 2d ago | 60/62 | **90** |
| **playwright-mcp** | ✅ | ✅ | ✅ | ✅ | ✅ | 35.3k | 5d ago | 865/871 | **89** |
| **Windows-MCP** | ✅ | ✅ | ✅ | ✅ | ✅ | 6.5k | today | 120/127 | **89** |
| **fast-agent** | ✅ | ✅ | ✅ | ✅ | ✅ | 3.9k | today | 236/252 | **89** |
| **gpt-researcher** | ✅ | ✅ | ✅ | ✅ | ✅ | 28.5k | 2d ago | 679/715 | **89** |
...
*Powered by GitHub Actions · Scanned daily · Last run: 2026-07-20 10:15 UTC*
